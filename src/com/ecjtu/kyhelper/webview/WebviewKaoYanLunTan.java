 ...
 * @date 2015年4月2日
 */
public class WebviewKaoYanLunTan extends Activity {

	private String url = "http://bbs.kaoyan.com/forum.php?mobile=2";
	...
	private void init() {
		...
		webView.setWebChromeClient(new WebChromeClient() {
			...
			private void openDialog(int newProgress) {
				if (dialog == null) {
					dialog = new ProgressDialog(WebviewKaoYanLunTan.this);
