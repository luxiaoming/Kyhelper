 ...
 * @date 2015年3月31日
 */
public class WebviewYuanXiaoZhuanYe extends Activity {

	private String url = "http://blog.nicerdata.com/院校专业.html";
	...
	private void init() {
		...
		// if (dialog == null) {
		// dialog = new ProgressDialog(WebviewYuanXiaoZhuanYe.this);
